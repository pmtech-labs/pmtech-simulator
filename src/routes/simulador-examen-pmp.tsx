      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "El motor de nuestro simulador clasifica cada respuesta incorrecta por tipo de error —secuencia, rol, conocimiento, interpretación del enunciado, sesgo predictivo/ágil, entre otros— y te muestra el patrón dominante para que estudies lo que realmente te está costando puntos.",
          ],
        },
        {
